...
class TimerApp(tk.Tk):
    def __init__(self):
        ...
        self.var.set("1")
        self.option = tk.OptionMenu(self, self.var, *choices, \
        ...
        self.hbutton = tk.Button(self.hframe, text="+1 hour", \
                                 command=self.addhour)
        self.hbutton.pack(side='top', padx=5, pady=0)
        self.shbutton = tk.Button(self.hframe, text="-1 hour", \
                                  command=self.subhour)
        self.shbutton.pack(side='bottom', padx=5, pady=0)
        self.hhframe = tk.Frame(self)
        self.hhframe.pack(side='left')
        self.hhbutton = tk.Button(self.hhframe, text="+30 min", \
                                  command=self.addhalfhour)
        self.hhbutton.pack(side='top', padx=5, pady=0)
        self.shhbutton = tk.Button(self.hhframe, text="-30 min", \
                                   command=self.subhalfhour)
        self.shhbutton.pack(side='bottom', padx=5, pady=0)
        self.qhframe = tk.Frame(self)
        self.qhframe.pack(side='left')
        self.qhbutton = tk.Button(self.qhframe, text="+15 min", \
                                  command=self.addqtrhour)
        self.qhbutton.pack(side='top', padx=5, pady=0)
        self.sqhbutton = tk.Button(self.qhframe, text="-15 min", \
                                   command=self.subqtrhour)
        self.sqhbutton.pack(side='bottom', padx=5, pady=0)
        self.minframe = tk.Frame(self)
        self.minframe.pack(side='left')
        self.minbutton = tk.Button(self.minframe, text="+1 min", \
                                   command=self.addminute)
        self.minbutton.pack(side='top', padx=5, pady=0)
        self.sminbutton = tk.Button(self.minframe, text="-1 min", \
                                    command=self.subminute)
        self.sminbutton.pack(side='bottom', padx=5, pady=0)
        self.tsecframe = tk.Frame(self)
        self.tsecframe.pack(side='left')
        self.tsecbutton = tk.Button(self.tsecframe, text="+30 sec", \
                                    command=self.addtsec)
        self.tsecbutton.pack(side='top', padx=5, pady=0)
        self.stsecbutton = tk.Button(self.tsecframe, text="-30 sec", \
                                     command=self.subtsec)
        self.stsecbutton.pack(side='bottom', padx=5, pady=0)
        self.fsecframe = tk.Frame(self)
        self.fsecframe.pack(side='left')
        self.fsecbutton = tk.Button(self.fsecframe, text="+15 sec", \
                                    command=self.addfsec)
        self.fsecbutton.pack(side='top', padx=5, pady=0)
        self.sfsecbutton = tk.Button(self.fsecframe, text="-15 sec", \
                                     command=self.subfsec)
        self.sfsecbutton.pack(side='bottom', padx=5, pady=0)
        self.secframe = tk.Frame(self)
        self.secframe.pack(side='left')
        self.secbutton = tk.Button(self.secframe, text="+1 sec", \
                                   command=self.addsecond)
        self.secbutton.pack(side='top', padx=5, pady=0)
        self.ssecbutton = tk.Button(self.secframe, text="-1 sec", \
                                    command=self.subsecond)
        self.ssecbutton.pack(side='bottom', padx=5, pady=0)
        self.optframe = tk.Frame(self)
        self.optframe.pack(side='left')
        self.ssbutton = tk.Button(self.optframe, text="Start/Stop", \
                                  command=self.switch)
    ...
    def refreshtime(self):
        ...
        self.label.configure(text="%d days, %d hours, %d minutes, %d seconds" \
                             % (self.d.day-1, self.d.hour, self.d.minute, \
                                self.d.second))
